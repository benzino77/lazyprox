...
class LXCGraphWidget(BaseGraphView):
    ...
    def update_data(self, data: list[str] | None) -> None:
        ...
        for entry in rrddata:
            if all(
                key in entry for key in ["mem", "maxmem", "cpu", "time", "netin", "netout", "diskwrite", "diskread"]
            ):
        ...
        lxc_memory_graph.set_data(
            ...
            series_y1_limit=maxmem / 1024 / 1024,
        )

        lxc_network_graph.set_data(
            series_x1=time_data,
            series_x1_limit=time_data[-1],
        ...
        lxc_disk_graph.set_data(
            series_x1=time_data,
            series_x1_limit=time_data[-1],
            series_y1=diskread_data,
            series_y1_limit=max_disk,
            series_x2=time_data,
            series_x2_limit=time_data[-1],
            series_y2=diskwrite_data,
            series_y2_limit=max_disk,
        )
